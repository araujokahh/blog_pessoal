	...
	OpenAPI springBlogPessoalOpenAPI() {
		return new OpenAPI()
				.info(new Info().title("Projeto Blog Pessoal").description("Projeto Blog Pessoal - Generation Brasil")
						...
						.contact(new Contact().name("Karina Camargo").url("https://github.com/araujokahh")
								.email("kacamargoaraujo@gmail.com")))
				.externalDocs(new ExternalDocumentation().description("GitHub").url("https://github.com/araujokahh"));
